...
You can then execute your native executable with: `./target/catalogservice-1.0-SNAPSHOT-runner`
...
- Hibernate Search ORM + Elasticsearch ([guide](https://quarkus.io/guides/hibernate-search-orm-elasticsearch)):
